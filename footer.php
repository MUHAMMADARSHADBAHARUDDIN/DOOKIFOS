		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<h3>About Us</h3>
					<p>Dookki means 'Two Meals' in Korean. It is a successful dining concept originating from the Republic of South Korea. Topokki, literally translated as "rice cake" is a beloved Korean dish which comes in many variations and has a rich history.
					With an unlimited supply of ingredients from the self serve bar, you can enjoy endless amounts of topokki prepared in various way. At Dookki, diners have fun creating their own unique recipes with friends and family.</p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>UseFull Links</h3>
					<ul class="list-inline f-social">
						...
						<li class="list-inline-item"><a href="https://www.instagram.com/mydookki/" target='_blank'><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
					</ul>
				</div>
				<div class="col-lg-3 col-md-6">
