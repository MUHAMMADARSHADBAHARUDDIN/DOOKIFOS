...
<div class="content">
   ...
   <td> Enter Title</td>
   <td><input type="text" name="foodId" value="'.$foodRecord['id'].'" placeholder="" class="text" required></td>
</tr> 
  <tr align="center">   
    ...
    <tr align="center"> 
			...
			<td><img src="'.$foodRecord['image'].'" width=70 height=70></td>
			<td><input type="File" name="img" value="'.$foodRecord['image'].'" placeholder="" class="" required></td>
	</tr>
